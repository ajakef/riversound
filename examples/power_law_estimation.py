...
if site.lower() == 'mrbd':
    freqs, spectrum = riversound.read_ref_spec('data/reference_spectra/MRBD_2021-09-13.txt')
elif site.lower() == 'wwp_p2_1':
    freqs, spectrum = riversound.read_ref_spec('data/reference_spectra/WWP_P2_1_2021-06-14.txt')
elif site.lower() == 'wwp':
    freqs, spectrum = riversound.read_ref_spec('data/reference_spectra/WWP_2021-05-24.txt')
elif site.lower() in ['annmorrison', 'settlers']:
    freqs, spectrum = riversound.read_ref_spec('data/reference_spectra/AnnMorrison_2021-04-27_2021-05-01.txt')
elif site.lower() in ['eckert', 'ridenbaugh']:
    freqs, spectrum = riversound.read_ref_spec('data/reference_spectra/Eckert_2021-05-24.txt')
...
d = riversound.band_bin(freqs, spectrum)
plt.loglog(d['centers'], d['psd'])
riversound.calc_degree_2pt(d['centers'], d['psd'], 40)
