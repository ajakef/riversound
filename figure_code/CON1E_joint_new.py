...
path = '/data/jakeanderson/2021_Boise_River/long_term/CON1E_DCEW/'
path_infrasound = path + '/mseed_all'
path_audible = path + '/audio_all'

day1 = obspy.UTCDateTime('2021-04-08')
day2 = obspy.UTCDateTime('2021-05-31')
...
t, q = riversound.read_DCEW('/data/jakeanderson/2021_Boise_River/long_term/Discharge/C1E_StreamHrlySummary_2021.csv')
plt.semilogy(t,q)
